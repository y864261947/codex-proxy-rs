...
fn source_tree_should_match_frozen_machine_manifest() {
    ...
    let mut expected = vec![
        ...
        "src/admin/channels.rs",
        "src/admin/client_keys.rs",
        "src/admin/customers.rs",
        "src/admin/quota_scopes.rs",
        "src/admin/access_groups.rs",
...
fn test_tree_should_match_frozen_rust_mirror() {
    ...
    let mut expected = vec![
        ...
        "tests/admin/channels.rs",
        "tests/admin/client_keys.rs",
        "tests/admin/customers.rs",
        "tests/admin/quota_scopes.rs",
        "tests/admin/access_groups.rs",
